        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 p-10">
          ...
          <div>
            <ul className="space-y-2">
              <li><a href="https://www.flyeducacao.org/" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300">Home</a></li>
              <li><a href="https://www.flyeducacao.org/transparencia" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300">Transparência</a></li>
            </ul>
          </div>

          <div>
            <ul className="space-y-2">
                <li><a href="https://www.flyeducacao.org/blog" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300">Blog</a></li>
                <li><a href="" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300">Carreiras e voluntariado</a></li>
                <li><a href="https://www.flyeducacao.org/contato" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300">Contato</a></li>
                <li><a href="https://www.instagram.com/flyeducacao/" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300">Instagram</a></li>
                <li><a href="https://www.linkedin.com/company/flyeducacao/posts/?feedView=all" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300">LinkedIn</a></li>
                <li><a href="https://www.youtube.com/@flyeducacaocultura1916" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300">YouTube</a></li>
            </ul>
          </div>

          <div>
            <ul className="space-y-2">
                <li><a href="https://www.flyeducacao.org/_files/ugd/d7a054_037066e32d514af58b94eb1fff2c16a4.pdf" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300">Estatuto social</a></li>
                <li><a href="https://www.flyeducacao.org/_files/ugd/d7a054_5f81febe170e4959b34f502ed2f1977d.pdf" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300">Diretores e conselheiros</a></li>
                <li><a href="https://www.flyeducacao.org/_files/ugd/d7a054_cb4442e7e7fb4da8aba6b1bff1f405c0.pdf" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300">Cartão CNPJ</a></li>
                <li><a href="https://www.flyeducacao.org/terms-and-conditions" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300">Termos & Condições </a></li>
                <li><a href="https://www.flyeducacao.org/privacy-policy" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300">Política de Privacidade</a></li>
                <li><a href="" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300">Política de Cookies</a></li>
              <li><a href="#" className="hover:text-gray-300">Termos & Condições</a></li>
              ...
              <li><a href="#" className="hover:text-gray-300">Cartão CNPJ</a></li>
            </ul>
          </div>
        </div>
